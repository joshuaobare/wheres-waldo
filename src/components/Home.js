    ...
    <div className="home">
      ...
      <div style={style} className="target-box">
        ...
        <div className="character-list">
          <div data-name="waldo" className="char-name" onClick={charChecker}>
            Waldo
          </div>
          <div data-name="odlaw" className="char-name" onClick={charChecker}>
            Odlaw
          </div>
          <div data-name="wilma" className="char-name" onClick={charChecker}>
            Wilma
          </div>
          <div
            data-name="whitebeard"
            className="char-name"
            onClick={charChecker}
          >
            Whitebeard
